    ...
    <tbody>
      ...
      <tr ng-repeat="roll in Products | orderBy:sortType:sortReverse | filter:searchProductName">
        ...
        <td>
             ...
             <a href="deleteDevice?id={{roll.ProductID}}">Delete</a>
             <a href="editDevice?id={{roll.ProductID}}">edit</a>
           <!-- 
        <a href="edit?id={{roll.DeviceID}}"><input type="submit" value="Edit"></a>&nbsp;
          <a href="deleteDevice?id={{roll.DeviceID}}""><input type="submit" value="Delete"></a>
